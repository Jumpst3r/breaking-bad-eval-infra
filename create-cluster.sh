exo compute sks create my-test-cluster --service-level starter --nodepool-name my-test-nodepool --nodepool-size 10 --nodepool-security-group sks-security-group --no-metrics-server --nodepool-instance-type large
